...
when emp_id=110 then 27
when emp_id=134 then 38
when emp_id=147 then 29
when emp_id=188 then 33
when emp_id=216 then 36
when emp_id=223 then 31
when emp_id=266 then 26
when emp_id=295 then 42
when emp_id=318 then 34
when emp_id=347 then 28
when emp_id=360 then 37
when emp_id=387 then 39
when emp_id=420 then 25
when emp_id=428 then 41
when emp_id=440 then 33
when emp_id=460 then 29
when emp_id=466 then 36
when emp_id=469 then 27
when emp_id=471 then 32
else 
age end
